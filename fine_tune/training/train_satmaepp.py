"""CLI Training entrypoint for SatMAE++ Grouped Multi-Spectral Foundation Model."""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune SatMAE++.")
    parser.add_argument("--config", type=str, default="fine_tune/configs/satmaepp.yaml", help="Path to YAML config.")
    ...
    summary = trainer.fit()
    print(f"\n[Finished] SatMAE++ fine-tuning complete. Results at: {trainer.results_dir / 'experiment.json'}")
