"""CLI Training entrypoint for Prithvi-EO-2.0-600M-TL Multispectral Segmentation."""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune Prithvi-EO-2.0-600M-TL.")
    parser.add_argument("--config", type=str, default="fine_tune/configs/prithvi.yaml", help="Path to YAML config.")
    ...
    summary = trainer.fit()
    print(f"\n[Finished] Prithvi fine-tuning complete. Results at: {trainer.results_dir / 'experiment.json'}")
